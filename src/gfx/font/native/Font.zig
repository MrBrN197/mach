...
pub fn render(
    ...
    f.bitmap.ensureTotalCapacity(f.allocator, num_pixels) catch return error.RenderError;
    f.bitmap.resize(f.allocator, num_pixels) catch return error.RenderError;
